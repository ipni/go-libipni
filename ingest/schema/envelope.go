...
// extendedSignaturePayload generates the data payload used to compute the
// signature for a provider from the ExtendedProviders list. This payload
// *doesn't* contain enough information to sign the ad itself.
